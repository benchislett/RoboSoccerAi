...
#define vmFILENAMESIZE \
  120                  //!< Max filename size including path, name, extension and termination (must be divideable by 4)
...
typedef enum { RED = 0, GREEN = 1, BLUE = 2, BLANK = 3, COLORS } COLOR;


/* Constants related to color sensor value using */
/* Color sensor as color detector                */
typedef enum { BLACKCOLOR = 1, BLUECOLOR = 2, GREENCOLOR = 3, YELLOWCOLOR = 4, REDCOLOR = 5, WHITECOLOR = 6 } NXTCOLOR;
...
#define PROGRAMHeader(VersionInfo, NumberOfObjects, GlobalBytes)                                                     \
  'L', 'E', 'G', 'O', LONGToBytes(0), WORDToBytes((UWORD) (BYTECODE_VERSION * 100.0)), WORDToBytes(NumberOfObjects), \
...
#define LX_byte2(v) ((v >> 8) & 0xFF)
#define LX_byte3(v) ((v >> 16) & 0xFF)
#define LX_byte4(v) ((v >> 24) & 0xFF)
#define LC4(v)                                                                                             \
  (PRIMPAR_LONG | PRIMPAR_CONST | PRIMPAR_4_BYTES), ((ULONG) v & 0xFF), (((ULONG) v >> (ULONG) 8) & 0xFF), \
      (((ULONG) v >> (ULONG) 16) & 0xFF), (((ULONG) v >> (ULONG) 24) & 0xFF)
...
#define LV2_byte0() (PRIMPAR_LONG | PRIMPAR_VARIABEL | PRIMPAR_LOCAL | PRIMPAR_2_BYTES)
#define LV4(i)                                                                                        \
  (PRIMPAR_LONG | PRIMPAR_VARIABEL | PRIMPAR_LOCAL | PRIMPAR_4_BYTES), (i & 0xFF), ((i >> 8) & 0xFF), \
      ((i >> 16) & 0xFF), ((i >> 24) & 0xFF)
...
#define GV4(i)                                                                                         \
  (PRIMPAR_LONG | PRIMPAR_VARIABEL | PRIMPAR_GLOBAL | PRIMPAR_4_BYTES), (i & 0xFF), ((i >> 8) & 0xFF), \
      ((i >> 16) & 0xFF), ((i >> 24) & 0xFF)
